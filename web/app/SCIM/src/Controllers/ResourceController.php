...
use App\SCIM\src\SCIM\ListResponse;
...
class ResourceController
{
    ...
    public function update(Request $request, ResourceType $resourceType, Model $resourceObject)
    {
        ...
        return \RobTrehy\LaravelAzureProvisioning\Utils\AzureHelper::objectToSCIMResponse($resourceObject, $resourceType);
    }
    ...
    public function createObject(Request $request, \App\SCIM\src\Resources\ResourceType $resourceType, $allowAlways = false)
    {
        $input = $request->input();
