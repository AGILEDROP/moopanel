...
namespace App\Filament\Admin\Clusters\Logs\Resources\ActivityLogResource\Pages;
...
class ViewActivityLog extends ViewActivity
{
    ...
    public function getBreadcrumbs(): array
    {
        return [
            ...
            ActivityLogResource::getUrl() => ActivityLogResource::getNavigationLabel(),
            //  self::getUrl(['record' => $this->getRecord()]) => __('View')
        ];
    }
}
