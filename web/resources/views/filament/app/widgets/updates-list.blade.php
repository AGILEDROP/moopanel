                ...
                <div class="ps-1.5 pe-1.5 block w-full">
                    <div class="flex-1 w-full">
                        <div class="flex flex-row items-start gap-6">
                            <div
                                class="flex h-16 w-16 rounded-md ring-white justify-center justify-items-center dark:ring-gray-900
                            ...
                            <div class="flex flex-col">
                                <div class="flex flex-col-reverse sm:flex-row gap-3">
                                    <span
                                        class="text-sm sm:text-lg text-base font-semibold order-2 sm:order-1 searchable-card-label mb-1.5 @if ($listItem['item_type'] == 'available') text-primary-500 dark:text-primary-400 @else text-gray-300 dark:text-gray-950 @endif">
                                        {{ $listItem['name'] }}
                                    </span>
                                    ...
                                    @isset($listItem['maturity'])
                                        <div class="order-1 sm:order-2">
                                            <x-filament::badge size="sm"
                                                color="{{ $listItem['maturity']->getDisplayColor() }}">
                                ...
                                <span
                                    class="text-md mt-2 leading-6 @if ($listItem['item_type'] == 'available') text-primary-500 dark:text-primary-400 @else text-gray-300 dark:text-gray-950 @endif">
                                    {{ $listItem['date'] }}
                                </span>
                            </div>
